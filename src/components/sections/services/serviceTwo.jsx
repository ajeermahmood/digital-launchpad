            ...
            <div className='max-w-[1350px] mx-auto px-[15px]'>
                <SlideUp>
                    <div className='flex flex-col items-center uppercase'>
                        <Button variant="secondary"><span className='uppercase'>some of the content you get inside...</span></Button>
                        <Title size={"5xl"} className="max-w-[869px] pt-6 text-center">the 3 best paths to launch your online career</Title>
                    </div>
                </SlideUp>
